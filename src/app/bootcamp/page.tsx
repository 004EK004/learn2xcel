...
export default function BootcampPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
        ...
        {cohorts.map((cohort) => (
          ...
          >
            ...
            <div className="relative space-y-2">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs text-cyan-100">
              ...
              <div className="flex flex-wrap gap-2 pt-3">
                {tracks.map((track) => (
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-2 text-xs font-semibold text-white transition hover:border-cyan-400/60"
                  >
      ...
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_25px_80px_rgba(0,0,0,0.5)]">
